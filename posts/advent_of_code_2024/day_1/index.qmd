...
I plan to use R mainly, and I think generally there are three ways to
approach (or three choices to prioritise for) AoC solutions: speed, code golf 
or readability. I'll be going for the latter of
the three so will be using tidyverse packages where possible.
